  ...
  return (
    <section className="container">
      ...
      <section className="subContainer">
        <h2>React</h2>
        <ul>
          <li>React의 렌더링 과정을 이해하고 상태 관리를 할 수 있습니다.</li>
          <li>
            재사용 가능한 컴포넌트를 통해 유지보수가 쉽도록 코드를 작성합니다.
          </li>
          <li>불변성 유지를 통한 부수효과 억제 및 가독성 향상을 추구합니다.</li>
        </ul>
      </section>
      <section className="subContainer">
        <h2>React Native</h2>
      ...
      <section className="subContainer">
        ...
        <ul>
          <li>ES6+ 문법을 사용합니다.</li>
          <li>
            실행 컨텍스트, 프로토타입, 클로저와 같은 javascript의 핵심을
            이해하고 있습니다.
          </li>
          <li>
            타입 추론을 통해 빠르게 코드를 작성하고 런타임 오류를 방지할 수
            있습니다.
          </li>
