...
export const SIDE_PROJECTS_DATA: TSideProject[] = [
    {
        ...
        techStacks: [TECH_STACKS.REACT, TECH_STACKS.TYPESCRIPT, TECH_STACKS.REDUX_TOOLKIT, TECH_STACKS.REACT_QUERY],
    },
    {
    ...
    },
    {
        ...
        techStacks: [TECH_STACKS.REACT, TECH_STACKS.TYPESCRIPT, TECH_STACKS.REACT_QUERY, TECH_STACKS.STYLED_COMPONENT],
    },
];
